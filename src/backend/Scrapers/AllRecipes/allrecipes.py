...
#TODO: THIS CODE NEEDS TO BE CHANGED AND ADAPTED TO PREETS NEW PIPELINE SYSTEM NEXT SPRINT
...
class AllRecipes:
    ...
    def fetch_recipe_details(recipe_url):
        ...
        try:
            ...
            steps = (
                [li.get_text(strip=True) for li in li_elements] if li_elements else []
            )
